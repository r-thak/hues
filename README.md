# Hues
A digital implementation of the popular board game [Hues and Cues](https://theop.games/products/hues-and-cues). My instance is available [here](https://hues.rthak.com) when it's running.

## Features
- Real-time Online Multiplayer w/ Rooms
- Interactive Board: A large, zoomable, and pannable color grid
- Scoring System: Automatic and adjustable point calculation
